        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">10,000+ Active Users</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">5,000+ Job Listings</h3>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Our users successfully find positions that match their goals</p>
            </div>
          </div>
        </div>
      </div>
